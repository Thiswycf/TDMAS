...
async def execute_python_code(code: str, timeout: int = 10) -> Tuple[Optional[str], Optional[str], bool]:
...
async def extract_and_execute_code(text: str, timeout: int = 10, max_concurrent_execute_code: int = 128) -> Tuple[Optional[str], Optional[str], bool]:
